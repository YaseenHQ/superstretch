...
public class AdminApi {
    ...
    /**
     * Build call for adminGetRunnersBreakdownByRegion
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns runner domains grouped by region </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call adminGetRunnersBreakdownByRegionCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/admin/runners/by-region";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminGetRunnersBreakdownByRegionValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return adminGetRunnersBreakdownByRegionCall(_callback);
     ...
     */
    public Map<String, List<String>> adminGetRunnersBreakdownByRegion() throws ApiException {
        ApiResponse<Map<String, List<String>>> localVarResp = adminGetRunnersBreakdownByRegionWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<String>>> adminGetRunnersBreakdownByRegionWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = adminGetRunnersBreakdownByRegionValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Map<String, List<String>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get runners breakdown by region (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call adminGetRunnersBreakdownByRegionAsync(final ApiCallback<Map<String, List<String>>> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminGetRunnersBreakdownByRegionValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Map<String, List<String>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
